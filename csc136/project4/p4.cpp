...
//Description:	Tests and implements the Polynomial class
...
///////////////////////////////////////////////////
//Function:	remove
//Description:	removes Term from the LinkedList
//Parameters:	Polynomial
//Returns:	void
///////////////////////////////////////////////////
void remove(Polynomial&);
...
//Asks the user for the exponent of the Term they wish to remove
//Then calls removeTerm to check if the LinkedList contains the Term
//If so, it removes the term and gives confirmation
//If not, tells the user of failure
void remove(Polynomial &poly)
{	int expn;
	cout << "Enter the exponent of the term you want to remove: ";
	cin >> expn;
	if(poly.removeTerm(expn)) //If term was found and removed
		cout << "Term was removed successfully!\n\n";
	else //If the term wasn't found
		cout << "Term was not removed!\n\n";
}
