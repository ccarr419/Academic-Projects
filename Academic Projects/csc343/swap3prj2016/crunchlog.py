...
# This version allows also combines SUM_waitForMemory and SUM_checkIfMemory
# into aggregate SUM_GETMEMORY
...
if __name__ == '__main__':
    ...
    # DEBUG HACK FOR FALL 2016 project 3
    if ('checkIfMemory' in reportkeys) and ('waitForMemory' in reportkeys):
        fcrunch.write('SUM_GETMEMORY=' + str(sumthreads['checkIfMemory']
            + sumthreads['waitForMemory']) + '\n')
    def despace(string):
