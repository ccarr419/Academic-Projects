/**
 *  stepvmDirectInC.c is the direct-threaded code rewrite of stepvmTokenInC.c
 *  Dale Parson Summer & Fall 2017. It uses the gcc && operator for gotos.
 ...
 *  stepvmDirectInC.c is D. Parson's solution to assignment 1.
...
static stepcode_t BASIC_codeMemory[] = {
     ...
     * and then terminates via SYSCALL(2).
    */
...
int main(int argc, char **argv) {
    static char *USAGE =
    "stepvmDirectInC DUMPONTERMINATION? TEST(e.g.BASIC) REPCOUNT\n";
    int isdump = 1 ;
    int i ;
    ...
    for (i = 2 ; i < argc ; i+= 2) {
        ...
        if (strcmp(argv[i], "BASIC") == 0) {
            ...
            /*
            fprintf(stderr, 
                "\trun_stepvmInC approx. elapsed real time = %d secs\n",
                    (int)(tafter-tbefore));
            */
            fprintf(stderr, 
